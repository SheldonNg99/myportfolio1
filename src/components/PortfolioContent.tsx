    ...
    >
      ...
      <div className="pointer-events-auto w-full max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4">
          <Link 
            to="/projects"
            className="px-6 py-3 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 rounded-full border-2 border-blue-400/60 bg-blue-500/20 hover:bg-blue-500/30 hover:-translate-y-0.5 transition-all duration-300 font-medium text-sm md:text-base text-center"
          >
            View Projects
          </Link>
          <a 
            href="mailto:kaijinng@gmail.com"
            className="px-6 py-3 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 rounded-full border-2 border-green-400/40 bg-green-500/10 hover:bg-green-500/20 hover:-translate-y-0.5 transition-all duration-300 text-sm md:text-base text-center"
          >
            Contact
          </a>
        </div>
